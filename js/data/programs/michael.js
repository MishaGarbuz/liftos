/** @file Michael Garbuz — 4-day tennis/strength program (Mon / Tue / Thu / Fri). */
const MICHAEL_PROGRAM_DAYS = {
  Mon: {
...
const MICHAEL_PROGRAM_BUNDLE = {
  id: "michael",
  displayName: "Michael Garbuz",
  email: null,
  programStartDate: null,
  gymDays: ["Mon", "Tue", "Thu", "Fri"],
  deloadWeeks: [6, 12],
  gymDayLabel: "Mon · Tue · Thu · Fri",
  phaseLabel(week) {
